...
//********************************************************************************************************************************************************
// Enequeing New Style Sheets and Scripts
...
{
    $script_asset = include get_parent_theme_file_path('public/js/index.asset.php');
    $style_asset  = include get_parent_theme_file_path('public/css/index.asset.php');

    wp_enqueue_script(
        'themeslug-editor',
        get_parent_theme_file_uri('public/js/index.js'),
    ...
    wp_enqueue_style(
        'themeslug-editor',
        get_parent_theme_file_uri('public/css/index.css'),
